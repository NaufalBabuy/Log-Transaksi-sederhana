...
<div class="custom-table" style="width: 100%">
        ...
        <div class="custom-table-cell" style="font-size: 11px; width:15%"> </div>
        <div class="custom-table-cell" style="font-size: 11px; width:80%">  <div class="col-lg-4 col-md-5 col-sm-10 col-xs-12">
