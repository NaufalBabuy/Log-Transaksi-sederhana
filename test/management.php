...
class Inventory {
    ...
    private $user  = 'root';
    private $password   = '';
    private $database  = 'interview_test';   
	private $userTable = 'test_user';	
    private $customerTable = 'test_customer';
	private $categoryTable = 'test_category';
	private $brandTable = 'test_brand';
	private $productTable = 'test_product';
	private $supplierTable = 'test_supplier';
	private $purchaseTable = 'test_purchase';
	private $orderTable = 'test_order';
