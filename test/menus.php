	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">		
				...
				<li class="nav-item"><a class="nav-link" href="customer.php" id="customer_menu">Kustomer</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="order.php" id="order_menu">Pemesanan</a></li>			
			</ul>
		</div>
		<ul class="nav navbar-nav">
			<li class="dropdown position-relative">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
					<li><a class="dropdown-item" href="action.php?action=logout">Log out</a></li>
					 <div style="font-size: 10px; margin-left: 5px; color: black; opacity: 60%"> <a href="signup.php">Signup</a><br><br></div>
				</ul>
			</li>
		</ul>
	</div>
